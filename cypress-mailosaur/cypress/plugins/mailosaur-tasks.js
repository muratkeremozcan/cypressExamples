...
const { env } = require('../../cypress.json') // use static file like this. GitLab env var approach is problematic.
const mailosaurClient = new MailosaurClient(env.MAILOSAUR_API_KEY)
...
const createEmail = () => {
  return mailosaurClient.servers.generateEmailAddress(env.MAILOSAUR_SERVERID)
}
